...
&lt;%&ndash; <script type="text/javascript" src="${ctxStatic}/jingle/js/lib/template.min.js"></script> &ndash;%&gt;
...
&lt;%&ndash; <script type="text/javascript" src="${ctxStatic}/jingle/js/lib/JChart.debug.js"></script> &ndash;%&gt;
<!--- app --->
	...
	<div class="weui-tab__panel">
		...
		<div class="weui-msg">
			...
			<div class="weui-msg__text-area">
				<h2 class="weui-msg__title">请用微信客户端打开连接</h2>
